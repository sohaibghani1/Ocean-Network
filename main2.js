function generatechordcm(matrix1){
  d3.csv("Data/species-oceanic-cm.csv", function(cities) {
  //d3.json("matrix2.json", function(matrix2) {


    var gs= [2, 3, 1, 1, 2 ,5, 0];
    var ls= [5, 2, 0,0,0, 5, 0, 1];
    var eco= [7,12,7,10,8,8,12,9];

    var arr = [2, 3, 1, 1, 2 ,5, 0,5, 2, 0,0,0, 5, 0, 1,7/3,7/3,7/3,12/3,12/3,12/3,7/3,7/3,7/3,10/3,10/3,10/3,8/3,8/3,8/3,8/3,8/3,8/3,12/3,12/3,12/3,9/3,9/3,9/3];
    ...
    var groupPath = group.append("path")
        ...
        .style("stroke-width", function(d, i) {return (arr[d.index] * 1.5); });
...
var colors = [ "#DF7C00", "#BFAE40", "green","white", "red","rgba(0,0,255,0.75)","#696969","cyan", "purple"];  //#083E77 bluish
